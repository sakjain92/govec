...
// func _govecSaxpy(N govec.UniformInt, alpha govec.UniformFloat32, X []govec.UniformFloat32,
// 				incX govec.UniformInt, Y []govec.UniformFloat32, incY govec.UniformInt) {
